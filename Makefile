...
SOURCES = \
	__init__.py \
	seismic_importer.py seismic_importer_dialog.py

PLUGINNAME = seismic_importer

PY_FILES = \
	__init__.py \
	seismic_importer.py seismic_importer_dialog.py

UI_FILES = seismic_importer_dialog_base.ui
...
QGISDIR=C:\Users\gsingh\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
